...
#
#     PHX_SERVER=true bin/riak_dashboard start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :riak_dashboard, RiakDashboardWeb.Endpoint, server: true
end
...
config :riak_dashboard,
       :riak_admin_url,
       System.get_env("RIAK_ADMIN_URL") ||
         Application.get_env(:riak_dashboard, :riak_admin_url, "http://localhost:8099")

config :riak_dashboard,
       :riak_ws_url,
       System.get_env("RIAK_WS_URL") ||
         Application.get_env(
           :riak_dashboard,
           :riak_ws_url,
           "ws://localhost:8099/api/stream/events"
         )
...
if config_env() == :prod do
  ...
  config :riak_dashboard, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
